...
enum Func7 {CUS_ADD = 0, CUS_DOUBLE_RS1 = 1, CUS_DOUBLE_RS2 = 2, CUS_ADD_MULTICYCLE = 3, CUS_PRNG1 = 5, CUS_PRNG2 = 6, CUS_PRNG3 = 7, CUS_LOAD = 8, CUS_STORE = 9, CUS_XOR_R = 10, CUS_ADD_RK = 11};
