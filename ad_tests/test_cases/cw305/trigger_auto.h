...
//start address
#define TRIGGER0_BASE_ADDR 0x40001000
...
// GPIO for trigger.
#define TRIGGER_GPIO_O(id) (TRIGGER##id##_BASE_ADDR + 0x0)
#define TRIGGER_GPIO_O_REG_OFFSET 0x0

//  Trigger the Keccak
#define TRIGGER_CTRL(id) (TRIGGER##id##_BASE_ADDR + 0x4)
...
#define TRIGGER_STATUS(id) (TRIGGER##id##_BASE_ADDR + 0x8)
